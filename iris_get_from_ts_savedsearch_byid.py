...
def main():
    ...
    parser = argparse.ArgumentParser(description="Fetch events based on a saved search (ID-based) from TimeSketch and import into case")
    parser.add_argument("sketch_id", type=int, help="TimeSketch ID")
    parser.add_argument("savedsearch_id", type=int, help="TimeSketch saved search ID")
